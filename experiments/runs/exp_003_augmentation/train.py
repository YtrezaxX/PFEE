"""
Training script for exp_003_augmentation.
Tests data augmentation (flips, rotations, intensity shifts).
"""
...
from common.datasets import GrainDistanceDatasetAugmented
...
def main():
    ...
    dataset = GrainDistanceDatasetAugmented(
        ...
        intensity_shift=True  # Enable intensity augmentation
    )
    ...
    print(f"Train: {len(train_dataset)}, Val: {len(val_dataset)} (with augmentation)")
