"""
Training script for exp_001_baseline.

Reproduces the original U-Net training pipeline from data_yukiko.
"""
...
def main():
    ...
    if not image_files or not distance_files:
        print("ERROR: Dataset not found!")
        print("Please generate the dataset first by running:")
        print("  cd /home/gma/epita/PFEE/data_yukiko/generate_dataset")
        print("  python dem2image_spam.py")
        print("  python dem2gt_distance_spam.py")
        return
    
    print(f"Found {len(image_files)} images and {len(distance_files)} distance maps")
